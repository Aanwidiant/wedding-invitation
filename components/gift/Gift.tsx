...
export default function Gift({ gift, recipientName }: GiftProps) {
    return (<section className='bg-surface px-6 py-20 sm:py-24'> <div className='mx-auto max-w-4xl'> <div className='text-center'> <p className='font-body text-secondary text-xs tracking-[0.3em] uppercase'>
        Hadiah Pernikahan </p>
