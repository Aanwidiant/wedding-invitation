...
export default function Hero({ groomName, brideName, date, imageSrc }: HeroProps) {
    return (
        <section className='grid md:grid-cols-2'>
            ...
            <div className='hero-fade-up flex flex-col items-center justify-center gap-5 px-6 py-14 text-center md:items-start md:px-16 md:text-left'>
                ...
                <h1 className='font-display text-foreground text-4xl leading-tight sm:text-5xl'>
                    {firstName(groomName)}
                ...
                <p className='font-body text-secondary max-w-sm text-sm leading-relaxed'>
                    Dengan penuh syukur, kami mengundang Bapak/Ibu/Saudara/i untuk turut merayakan
                    hari bahagia pernikahan kami.
                </p>

                <p className='font-display text-primary text-lg tracking-wide'>{date}</p>
            </div>
        </section>
    );
}
